...
export async function getBalance(
	...
	return await nanoRPCCall<AccountBalanceRPCResponse>(context, config, 'account_balance', params);
}
...
export async function getAccountBlockCount(
	...
	return await nanoRPCCall<AccountBlockCountRPCResponse>(context, config, 'account_block_count', {
		account,
	});
}
...
export async function getAccountRepresentative(
	...
	return await nanoRPCCall<AccountRepresentativeRPCResponse>(
		context,
		config,
...
export async function getAccountWeight(
	...
	return await nanoRPCCall<AccountWeightRPCResponse>(context, config, 'account_weight', {
		account,
	});
}
...
export async function getAccountsFrontiers(
	...
	return await nanoRPCCall<AccountsFrontiersRPCResponse>(context, config, 'accounts_frontiers', {
		accounts,
	});
}
...
export async function validateAccount(
	...
	return await nanoRPCCall<ValidateAccountRPCResponse>(context, config, 'validate_account_number', {
		account,
	});
}
