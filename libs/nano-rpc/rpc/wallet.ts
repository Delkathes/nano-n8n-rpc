...
export async function accountMove(
	...
	return await nanoRPCCall<AccountMoveRPCResponse>(context, config, 'account_move', {
		wallet,
		source,
		accounts,
	});
...
export async function accountRemove(
	...
	return await nanoRPCCall<AccountRemoveRPCResponse>(context, config, 'account_remove', {
		wallet,
		account,
	});
}
...
export async function accountRepresentativeSet(
	...
	return await nanoRPCCall<AccountRepresentativeSetRPCResponse>(
		context,
		config,
...
export async function passwordChange(
	...
	return await nanoRPCCall<PasswordChangeRPCResponse>(context, config, 'password_change', {
		wallet,
		password,
	});
}
...
export async function passwordEnter(
	...
	return await nanoRPCCall<PasswordEnterRPCResponse>(context, config, 'password_enter', {
		wallet,
		password,
	});
}
 ...
 */
export async function receiveMinimum(
	context: IExecuteFunctions,
	config: INanoRPCConfig,
): Promise<ReceiveMinimumRPCResponse> {
...
export async function receiveMinimumSet(
	...
	return await nanoRPCCall<ReceiveMinimumSetRPCResponse>(context, config, 'receive_minimum_set', {
		amount,
	});
}
...
export async function searchReceivable(
	...
	return await nanoRPCCall<SearchReceivableRPCResponse>(context, config, 'search_receivable', {
		wallet,
	});
}
...
export async function searchReceivableAll(
	...
	return await nanoRPCCall<SearchReceivableRPCResponse>(
		context,
		config,
...
export async function walletAddWatch(
	...
	return await nanoRPCCall<WalletAddWatchRPCResponse>(context, config, 'wallet_add_watch', {
		wallet,
		accounts,
	});
}
...
export async function walletBalances(
	...
	return await nanoRPCCall<WalletBalancesRPCResponse>(context, config, 'wallet_balances', {
		wallet,
		threshold,
	});
}
...
export async function walletChangeSeed(
	...
	return await nanoRPCCall<WalletChangeSeedRPCResponse>(context, config, 'wallet_change_seed', {
		wallet,
		seed,
		count,
	});
...
export async function walletContains(
	...
	return await nanoRPCCall<WalletContainsRPCResponse>(context, config, 'wallet_contains', {
		wallet,
		account,
	});
}
...
export async function walletCreate(
	...
	return await nanoRPCCall<WalletCreateRPCResponse>(context, config, 'wallet_create', { seed });
}
...
export async function walletFrontiers(
	...
	return await nanoRPCCall<WalletFrontiersRPCResponse>(context, config, 'wallet_frontiers', {
		wallet,
	});
}
...
export async function walletReceivable(
	...
	return await nanoRPCCall<WalletReceivableRPCResponse>(
		context,
		config,
		'wallet_receivable',
		params,
...
export async function walletRepresentative(
	...
	return await nanoRPCCall<WalletRepresentativeRPCResponse>(
		context,
		config,
...
export async function walletRepresentativeSet(
	...
	return await nanoRPCCall<WalletRepresentativeSetRPCResponse>(
		context,
		config,
...
export async function walletRepublish(
	...
	return await nanoRPCCall<WalletRepublishRPCResponse>(context, config, 'wallet_republish', {
		wallet,
		count,
	});
}
...
export async function walletWorkGet(
	...
	return await nanoRPCCall<WalletWorkGetRPCResponse>(context, config, 'wallet_work_get', {
		wallet,
	});
}
...
export async function workSet(
	...
	return await nanoRPCCall<WorkSetRPCResponse>(context, config, 'work_set', {
		wallet,
		account,
		work,
	});
