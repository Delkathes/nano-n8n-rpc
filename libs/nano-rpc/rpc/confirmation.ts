...
export async function getConfirmationActive(
	...
	return await nanoRPCCall<ConfirmationActiveRPCResponse>(
		context,
		config,
		'confirmation_active',
		options,
 ...
 */
export async function getConfirmationHistory(
	context: IExecuteFunctions,
	config: INanoRPCConfig,
	hash?: string,
): Promise<ConfirmationHistoryRPCResponse> {
	return await nanoRPCCall<ConfirmationHistoryRPCResponse>(
		context,
		config,
...
export async function getConfirmationInfo(
	...
	return await nanoRPCCall<ConfirmationInfoRPCResponse>(context, config, 'confirmation_info', {
		root,
		...options,
	});
}
...
export async function getConfirmationQuorum(
	...
	return await nanoRPCCall<ConfirmationQuorumRPCResponse>(
		context,
		config,
		'confirmation_quorum',
		options,
...
export async function getElectionStatistics(
	context: IExecuteFunctions,
	config: INanoRPCConfig,
): Promise<ElectionStatisticsRPCResponse> {
