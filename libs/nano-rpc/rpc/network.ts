...
): Promise<AvailableSupplyRPCResponse> {
...
export async function getRepresentativesOnline(
	...
	return await nanoRPCCall<RepresentativesOnlineRPCResponse>(
		context,
		config,
...
export async function republish(
	...
	return await nanoRPCCall<RepublishRPCResponse>(context, config, 'republish', {
		hash,
		count,
		sources,
		destinations,
