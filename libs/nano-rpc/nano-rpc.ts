...
export function createNanoRPC(context: IExecuteFunctions, config: rpcTypes.INanoRPCConfig) {
  return {
    // Account Operations
    getBalance: (account: string, includeOnlyConfirmed?: boolean) => rpc.getBalance(context, config, account, includeOnlyConfirmed),
    ...
    getAccountInfo: (account: string, options?: rpcTypes.AccountInfoOptions) => rpc.getAccountInfo(context, config, account, options),
    getAccountKey: (account: string) => rpc.getAccountKey(context, config, account),
    getAccountRepresentative: (account: string) => rpc.getAccountRepresentative(context, config, account),
    getAccountWeight: (account: string) => rpc.getAccountWeight(context, config, account),
    getAccountHistory: (account: string, count?: number, options?: rpcTypes.AccountHistoryOptions) => rpc.getAccountHistory(context, config, account, count, options),
    getAccountsBalances: (accounts: string[], options?: rpcTypes.AccountsBalancesOptions) => rpc.getAccountsBalances(context, config, accounts, options),
    getAccountsFrontiers: (accounts: string[]) => rpc.getAccountsFrontiers(context, config, accounts),
    ...
    getAccountsRepresentatives: (accounts: string[]) => rpc.getAccountsRepresentatives(context, config, accounts),
    ...
    getBlockHash: (block: rpcTypes.BlockContents, jsonBlock?: boolean) => rpc.getBlockHash(context, config, block, jsonBlock),
    ...
    getBlocksInfo: (hashes: string[], options?: rpcTypes.BlocksInfoOptions) => rpc.getBlocksInfo(context, config, hashes, options),
    ...
    accountRemove: (wallet: string, account: string) => rpc.accountRemove(context, config, wallet, account),
    accountRepresentativeSet: (wallet: string, account: string, representative: string, options?: rpcTypes.AccountRepresentativeSetOptions) =>
    ...
    passwordChange: (wallet: string, password: string) => rpc.passwordChange(context, config, wallet, password),
    passwordEnter: (wallet: string, password: string) => rpc.passwordEnter(context, config, wallet, password),
    ...
    walletAddWatch: (wallet: string, accounts: string[]) => rpc.walletAddWatch(context, config, wallet, accounts),
    walletBalances: (wallet: string, threshold?: string) => rpc.walletBalances(context, config, wallet, threshold),
    walletChangeSeed: (wallet: string, seed: string, count?: number) =>
      rpc.walletChangeSeed(context, config, wallet, seed, count),
    walletContains: (wallet: string, account: string) => rpc.walletContains(context, config, wallet, account),
    ...
    walletHistory: (wallet: string, modifiedSince?: number) => rpc.walletHistory(context, config, wallet, modifiedSince),
    ...
    walletRepublish: (wallet: string, count?: number) => rpc.walletRepublish(context, config, wallet, count),
    ...
    workSet: (wallet: string, account: string, work: string) => rpc.workSet(context, config, wallet, account, work),
    ...
    getRepresentatives: (count?: number, sorting?: boolean) => rpc.getRepresentatives(context, config, count, sorting),
    getRepresentativesOnline: (options?: rpcTypes.RepresentativesOnlineOptions) => rpc.getRepresentativesOnline(context, config, options),
    ...
    getTelemetry: (options?: rpcTypes.TelemetryOptions) => rpc.getTelemetry(context, config, options),
    ...
    getFrontiers: (account: string, count: number) => rpc.getFrontiers(context, config, account, count),
    ...
    getUnopened: (account?: string, count?: number) => rpc.getUnopened(context, config, account, count),

    // Confirmation Operations
    getConfirmationActive: (options?: rpcTypes.ConfirmationActiveOptions) => rpc.getConfirmationActive(context, config, options),
    ...
    getConfirmationQuorum: (options?: rpcTypes.ConfirmationQuorumOptions) => rpc.getConfirmationQuorum(context, config, options),
    ...
    // Key Operations
    getDeterministicKey: (seed: string, index: number) => rpc.getDeterministicKey(context, config, seed, index),
    ...
    bootstrapAny: (options?: rpcTypes.BootstrapAnyOptions) => rpc.bootstrapAny(context, config, options),
    ...
    getUncheckedKeys: (key?: string, count?: number) => rpc.getUncheckedKeys(context, config, key, count),
